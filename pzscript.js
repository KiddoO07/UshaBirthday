...
function reloadPuzzle() {
  ...
  document.getElementById('awardButton').style.display = 'none'; // Hide again if reset
}
    ...
    if (document.querySelector('.clicked')) {
      ...
      if (clickedElement.classList.contains(element.classList[0])) {
        ...
        if (document.querySelectorAll('.dropped').length == 9) {
          ...
          document.getElementById('awardButton').style.display = 'inline-block'; // 👈 Show the button
        }
      }
    }
  });
